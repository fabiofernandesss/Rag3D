...
| RULE-008 | AGENT-GIT-PR; AGENT-SECRET-REMEDIATION; AGENT-CLEAN-HISTORY-REVIEW | commits/push/PR | diff checks, history scan e checks GitHub | artefatos no PR | 9 commits; branch limpa no fork; [PR #2](https://github.com/fabiofernandesss/Rag3D/pull/2) verificado | concluído |
